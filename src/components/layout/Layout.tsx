...
export default function Layout() {
  const footerData = {
    companyInfo: {
      name: "Eager Minds",
      description:
        "Where Curious Minds Become Brilliant Thinkers. Expert preparation for the next generation of innovators.",
    },
    socialLinks: [
      {
        platform: "instagram",
  ...
  return (
    <div className="app-layout min-h-screen relative overflow-x-hidden bg-background">
      <HeroBackground />
      <FullscreenNavbar />
