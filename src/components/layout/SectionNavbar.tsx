              ...
              <>
                <Link to="/login">
                  <Button
                    variant="ghost"
                    size="sm"
                    className="h-9 rounded-full px-5 text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-white hover:bg-white/5 transition-all"
                  >
                    Login
                  </Button>
                </Link>
                <Link to="/register">
                  <Button
                    size="sm"
                    className="h-9 rounded-full px-6 text-[10px] font-black uppercase tracking-widest bg-white text-black hover:bg-white/90 shadow-[0_0_20px_rgba(255,255,255,0.2)] transition-all"
                  >
                    Get Started
                  </Button>
                </Link>
              ...
              {isLoggedIn ? (
                ...
                <>
                  <Link to="/login" onClick={() => setMobileOpen(false)}>
                    <Button
                      variant="outline"
                      className="w-full h-12 rounded-2xl border-white/10 text-white font-black uppercase tracking-widest text-[10px]"
                    >
                      Login
                    </Button>
                  </Link>
