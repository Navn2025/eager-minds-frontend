  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        className={`
          relative cursor-pointer rounded-2xl border-2 border-dashed transition-all duration-300 backdrop-blur-xl
          ${
            isDragging
              ? "border-accent bg-accent/10 scale-[1.02] shadow-[0_0_30px_rgba(168,85,247,0.2)]"
            ...
            >
              <div
                className={`
                  ...
                  ${isDragging ? "bg-accent/20 text-accent scale-110 border-accent/20" : "bg-white/5 text-white/30 border-white/5"}
                `}
              >
              ...
              {multiple && previews.length > 0 && (
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div
                    ...
                    className="aspect-square rounded-xl border-2 border-dashed border-white/10 hover:border-white/30 flex items-center justify-center transition-colors bg-white/2 hover:bg-white/5"
                  >
  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        className={`
          relative cursor-pointer rounded-2xl border-2 border-dashed py-8 px-6 transition-all duration-300 backdrop-blur-xl
          ${
            isDragging
              ? "border-accent bg-accent/10 shadow-[0_0_30px_rgba(168,85,247,0.2)]"
              : "border-white/10 hover:border-white/25 bg-white/2 hover:bg-white/5"
          }
        `}
      >
        ...
        <div className="flex items-center gap-4">
          <div
            className={`
              ...
              ${fileName ? "bg-emerald-500/20 text-emerald-400 border-emerald-500/10" : "bg-white/5 text-white/30 border-white/5"}
            `}
          >
            <Upload size={24} />
          </div>
