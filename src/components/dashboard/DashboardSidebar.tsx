...
const sidebarItems = [
  ...
  { icon: Sparkles, label: "Word of Day", to: "/dashboard/word-of-the-day" },
  { icon: BrainCircuit, label: "AI Quiz", to: "/dashboard/quiz" },
    ...
    <aside className="w-80 border-r border-white/5 bg-surface flex flex-col h-full relative overflow-hidden shrink-0">
      ...
      <div className="p-10 flex items-center justify-between">
        <Link
          to="/"
          onClick={onClose}
          className="text-2xl font-black tracking-tighter text-white flex items-center gap-3 group"
        >
          <img
            src={logo}
      ...
      <nav className="flex-grow px-6 overflow-y-auto space-y-8 scrollbar-none">
        <div className="space-y-2">
          <p className="px-4 text-[10px] font-black uppercase tracking-[0.3em] text-white/20 mb-4">
            Main Menu
          </p>
                ...
                <div className="flex items-center gap-4">
                  <item.icon
                    ...
                    className={cn(
                      isActive
                        ? "text-accent"
                        : "text-white/20 group-hover:text-white/60 transition-colors",
                    )}
                  />
        ...
        <div className="pt-8 border-t border-white/5 space-y-2">
          ...
          <Link
            to="/"
            onClick={onClose}
            className="flex items-center gap-4 px-5 py-4 rounded-2xl transition-all duration-300 group text-text-secondary hover:text-white"
          >
            <House
              size={20}
        ...
        <div className="matte-card p-6 relative overflow-hidden group hover:scale-[1.02] transition-transform">
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-[9px] bg-accent/20 text-accent px-3 py-1 rounded-full font-black tracking-widest border border-accent/20">
                PREMIUM
              </span>
            </div>
            ...
            <p className="text-[9px] text-white/20 font-medium mt-3 uppercase tracking-widest italic">
              Syncing Progress...
            </p>
          </div>
