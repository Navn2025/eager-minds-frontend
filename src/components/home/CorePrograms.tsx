...
const programs = [
  ...
  {
    title: "English",
    description: "Advanced literacy, comprehension, and analytical writing skills.",
    icon: BookOpen,
  ...
  },
  {
    ...
    description: "Developing linguistic insight and logical deduction abilities.",
    icon: MessageCircle,
    ...
    <section className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Comprehensive preparation across four core disciplines designed for academic success.
          </motion.p>
        </div>
          ...
          {programs.map((program, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`w-12 h-12 rounded-2xl ${program.accent}/10 flex items-center justify-center mb-6 border border-${program.accent}/20`}>
              ...
              <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${program.color} blur-3xl opacity-50`} />
            </motion.div>
          ))}
        </div>
      </div>
