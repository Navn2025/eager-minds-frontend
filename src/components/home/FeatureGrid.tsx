...
const features = [
  {
    ...
    description:
      "Comprehensive resources for Maths, English, and Reasoning success with expert-led methodology.",
    icon: BookOpen,
  },
  {
    title: "Monthly Competitions",
    description:
      "Exciting monthly challenges to sharpen young minds and win prestigious achievement awards.",
    icon: Trophy,
  },
  {
    title: "Creative Activities",
    description:
      "Hands-on projects that blend advanced learning with high-end artistic expression.",
    icon: Palette,
  },
  {
    title: "Word of the Day",
    description:
      "Expand vocabulary with curated terms, etymology, and sophisticated usage examples.",
    icon: MessageSquare,
  },
  {
    title: "Premium Papers",
    description:
      "Exclusive mock tests and past papers for ultimate exam readiness and performance audits.",
    icon: FileText,
  },
  {
    title: "Progress Tracking",
    description:
      "Visual analytics to monitor growth and identify specific cognitive improvement areas.",
    icon: LineChart,
  },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col items-start text-left mb-20">
          ...
          <h2 className="section-title max-w-3xl">
            Educational <span className="text-gradient">Excellence</span>{" "}
            Redefined.
          </h2>
          <p className="text-text-secondary text-lg max-w-2xl font-medium leading-relaxed uppercase tracking-wider">
            Our platform provides the elite tools and resources every young
            learner needs to excel academically and creatively.
          </p>
        </div>
