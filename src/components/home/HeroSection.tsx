  ...
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-20 overflow-hidden">
      <div className="container mx-auto px-6 relative z-10 flex flex-col items-start text-left">
        ...
        >
          Explore worksheets, competitions, and creative learning designed for
        ...
        >
          <Button
            size="lg"
            className="h-14 px-10 rounded-2xl bg-white text-black font-black uppercase tracking-widest hover:scale-105 transition-all duration-500 shadow-[0_0_40px_rgba(255,255,255,0.2)] group relative overflow-hidden"
          >
          ...
          <Button
            variant="ghost"
            size="lg"
            className="h-14 px-10 rounded-2xl border border-white/10 text-white/60 font-black uppercase tracking-widest hover:bg-white/5 hover:text-white transition-all group glass"
          >
            Explore Resources
          </Button>
        </motion.div>
        ...
        >
          <div className="flex -space-x-4">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="w-10 h-10 rounded-full border-2 border-black bg-surface overflow-hidden glass accent-glow"
              >
