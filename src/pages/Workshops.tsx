      ...
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        >
          ...
          <p className="text-xl text-white/50 max-w-2xl leading-relaxed">
            Join our upcoming workshops and holiday clubs — hands-on, creative,
            and unforgettable.
          </p>
        </motion.div>
        ...
        <div className="mb-16">
          ...
          {upcoming.length === 0 ? (
            <div className="text-left py-16 bg-white/[0.01] border border-dashed border-white/5 rounded-2xl">
        ...
        <motion.div
          ...
          animate="visible"
          custom={0.4}
          className="mb-16 bg-gradient-to-br from-pink-500/10 via-purple-500/10 to-sky-500/10 border border-purple-400/20 rounded-2xl p-8 text-left"
        >
          <h3 className="text-xl font-black text-white mb-3">
            Want to Register for a Workshop?
          </h3>
          <p className="text-white/50 text-sm mb-6 max-w-md">
            Fill in our registration form to express your interest and we'll
            reach out with availability.
          </p>
          <a
