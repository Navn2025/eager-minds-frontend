...
export default function EagerMindsHomepage() {
    ...
    >
      ...
      {!isMobile && (
        <div style={{ display: "flex", gap: 30 }}>
          {["Home", "11+ Prep", "Competitions", "Arts & Craft", "Blog"].map(
            (link) => (
              <a
                key={link}
                href="#"
                ...
                style={{
                  ...
                  borderRadius: 20,
                  backgroundColor:
                    hoveredNav === link ? colors.yellow : "transparent",
  ...
  const Hero = () => (
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M0,200 C300,50 600,250 1440,100 L1440,300 L0,300 Z"
            fill="#95D5B2"
            opacity="0.5"
          />
          <path
            d="M0,250 C400,100 800,280 1440,150 L1440,300 L0,300 Z"
            fill={colors.grass}
          />
        </svg>
      </div>
      ...
      >
        ...
        >
          Explore worksheets, competitions, and creative adventures
          <br />
          ...
          <button
            ...
            style={{
              ...
              boxShadow: hoveredCTA
                ? "0 10px 30px rgba(251, 133, 0, 0.5)"
                : "0 6px 20px rgba(251, 133, 0, 0.3)",
  ...
  const Features = () => (
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M0,50 C400,-20 800,120 1440,50 L1440,100 L0,100 Z"
            fill="white"
          />
        </svg>
      </div>
          ...
          {[
            {
              ...
              icon: "📝",
              title: "11+ Prep",
              desc: "Master English, Maths & Reasoning",
              color: colors.blue,
            },
            {
              id: 2,
              icon: "🏆",
              title: "Competitions",
              desc: "Win exciting prizes & certificates",
              color: colors.yellow,
            },
            {
              id: 3,
              icon: "🎨",
              title: "Arts & Craft",
              desc: "Express your creativity freely",
              color: colors.orange,
            },
            {
              id: 4,
              icon: "📖",
              title: "Story Worksheets",
              desc: "Learn through magical stories",
              color: colors.green,
            },
          ].map((item) => (
            <div
          ...
          {[
            {
              ...
              age: 7,
              quote:
                "I love the space adventure worksheets! They make me feel like a real astronaut.",
              avatar: "#FFD166",
            },
            {
              name: "Mia",
              age: 9,
              quote:
                "The drawing competitions are so much fun. I won a silver medal last month!",
              avatar: "#8ECAE6",
            },
            {
              name: "Noah",
              age: 10,
              quote:
                "English prep feels like reading a storybook now. No more boring homework!",
              avatar: "#FB8500",
            },
          ].map((t, i) => (
            <div
            ...
            >
              ...
              >
                <svg width="80" height="80" viewBox="0 0 100 100">
                  ...
                  />
                  <path
                    d="M30 30 Q50 10 70 30 L70 50 Q50 60 30 50 Z"
                    fill={t.avatar}
                    opacity="0.8"
                  />
                </svg>
              ...
              >
                {[1, 2, 3, 4, 5].map((s) => (
                  <span key={s} style={{ color: colors.orange, fontSize: 20 }}>
                    ★
                  </span>
                ))}
              </div>
  ...
  const CTABanner = () => (
    ...
    >
      ...
      >
        ...
        >
          Join thousands of curious minds today and start growing brilliant
          ideas.
        </p>
        <button
          style={{
  ...
  const Footer = () => (
    <footer
      style={{
        ...
        padding: "80px 20px",
        textAlign: "center",
        borderTop: `2px solid ${colors.sky}`,
      }}
    >
      <div
        style={{
      ...
      >
        ...
        >
          Where Curious Minds Grow Brilliant Ideas. Making learning a magical
          adventure for every child since 2025.
        </p>
  ...
  const HotAirBalloon = () => (
    <div style={{ position: "relative" }}>
      ...
      <svg width="250" height="350" viewBox="0 0 200 280">
        {/* Balloon Body */}
        <path
          d="M30,100 Q30,20 100,20 Q170,20 170,100 Q170,180 100,220 Q30,180 30,100"
          fill={colors.orange}
        />
        {/* Stripes */}
        <path
          d="M70,22 Q50,50 50,100 Q50,150 85,210"
          fill="transparent"
        ...
        />
        <path
          d="M130,22 Q150,50 150,100 Q150,150 115,210"
          fill="transparent"
          stroke={colors.blue}
          strokeWidth="20"
          opacity="0.8"
        ...
        <path
          d="M70,250 L130,250 M70,260 L130,260 M70,270 L130,270"
          stroke="rgba(0,0,0,0.2)"
          strokeWidth="1"
        />
        <path
          d="M80,240 L80,280 M100,240 L100,280 M120,240 L120,280"
          stroke="rgba(0,0,0,0.2)"
          strokeWidth="1"
        />
        {/* Kid 1 - Reading */}
        <circle cx="85" cy="235" r="12" fill="#FFE5D9" />
        <rect x="78" y="225" width="14" height="6" rx="3" fill="#333" />{" "}
        {/* Hair */}
        ...
        <path
          d="M105,225 Q115,220 125,225 L125,235 L105,235 Z"
          fill="#FFB703"
        />{" "}
        {/* Cap */}
  ...
  const Tree = ({ x, y }: { x: number | string; y: number | string }) => (
    <div
      style={{
        position: "absolute",
        left: x,
  ...
  const Book = ({
    ...
    <div
      style={{
        ...
        left: x,
        top: y,
        animation: `balloonFloat 5s ease-in-out infinite ${delay}`,
      }}
    >
      <svg width="40" height="30" viewBox="0 0 40 30">
        ...
        />
        <path
          d="M5,10 H18 M5,15 H18 M5,20 H12 M22,10 H35 M22,15 H35 M22,20 H28"
          stroke="#ccc"
          strokeWidth="1"
        />
      </svg>
  ...
  const Pencil = ({
    ...
    <div
      style={{
        ...
        left: x,
        top: y,
        animation: `wiggle 2s ease-in-out infinite alternate ${delay}`,
      }}
    >
      <svg width="50" height="15" viewBox="0 0 50 15">
        <polygon
          points="0,7.5 10,0 45,0 45,15 10,15"
          fill={colors.yellow}
          stroke={colors.brown}
          strokeWidth="1"
        />
  ...
  const Paintbrush = ({
    ...
    <div
      style={{
        ...
        left: x,
        top: y,
        animation: `wiggle 3s ease-in-out infinite alternate ${delay}`,
      }}
    >
  ...
  const Puzzle = ({
    ...
    <div
      style={{
        ...
        left: x,
        top: y,
        animation: `bounce 4s ease-in-out infinite ${delay}`,
      }}
    >
      <svg width="30" height="30" viewBox="0 0 30 30">
        <path
          d="M10,5 Q15,0 20,5 L20,10 Q15,15 20,20 L15,20 Q10,25 5,20 L5,15 Q0,10 5,5 Z"
          fill={colors.teal}
          stroke={colors.brown}
          strokeWidth="1"
        />
  ...
  const PaperPlane = ({
    ...
    <div
      style={{
        ...
        left: x,
        top: y,
        animation: `planeDrift 6s ease-in-out infinite ${delay}`,
      }}
    >
      <svg width="40" height="30" viewBox="0 0 40 30">
        <path
          d="M0,15 L40,0 L15,20 L15,30 L22,23 L40,0"
          fill="white"
          stroke={colors.blue}
          strokeWidth="1"
        />
  ...
  const SmallDog = () => (
    <svg width="60" height="40" viewBox="0 0 60 40">
      ...
      <rect x="52" y="15" width="4" height="12" rx="2" fill="#5A4A3B" />{" "}
      {/* Ear */}
