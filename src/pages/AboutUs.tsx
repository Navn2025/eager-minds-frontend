      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          ...
          <p className="text-xl text-white/50 max-w-2xl leading-relaxed">
            A creative learning club designed to inspire curiosity, creativity,
            and confidence in children through arts, science projects, coding
              ...
              <div className="relative h-full bg-gradient-to-br from-pink-500 via-purple-600 to-violet-700 rounded-[2.5rem] p-10 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-2xl md:text-3xl font-black text-white leading-snug tracking-tight">
                    ...
                    children can explore their creativity, ignite their
                    curiosity, and develop a lifelong passion for learning.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="h-full bg-white/[0.02] border border-white/10 rounded-[2.5rem] p-10 overflow-hidden relative group hover:border-purple-400/30 transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg md:text-xl font-medium text-white/60 leading-relaxed">
                  ...
                  curiosity in young learners, transforming the ordinary into
                  the extraordinary. We empower each child to embrace their
                  unique potential — through hands-on activities, creative
                  challenges, and a nurturing community — and become the
