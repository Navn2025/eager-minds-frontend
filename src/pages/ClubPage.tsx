...
export default function ClubPage({ name = "This Club" }: { name?: string }) {
  return (
    <div className="min-h-screen bg-transparent pt-28 pb-24 flex flex-col items-center justify-center">
      <div className="text-center max-w-lg mx-auto px-6">
        ...
        >
          Detailed information for this club is coming soon. Check back shortly
          or{" "}
          <a
            href="/contact"
            className="text-purple-400 hover:text-pink-400 transition-colors font-bold"
          >
            get in touch
          </a>{" "}
          to learn more.
