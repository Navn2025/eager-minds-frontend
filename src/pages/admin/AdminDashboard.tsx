                    ...
                    <tr key={enq.id} className="group cursor-pointer">
                      ...
                      <td className="py-4 md:py-6 px-4 md:px-8 bg-white/[0.01] border-y border-r border-white/5 rounded-r-2xl md:rounded-r-3xl text-right group-hover:bg-white/[0.03] transition-all">
                        <button
                          ...
                          aria-label="Open enquiry details"
                          className="w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl bg-white/[0.05] border border-white/5 flex items-center justify-center text-white/20 group-hover:text-accent group-hover:border-accent transition-all shadow-xl ml-auto"
                        >
