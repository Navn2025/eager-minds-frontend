        ...
        <CardContent className="p-6 md:p-10 pt-4 flex flex-col flex-grow">
          ...
          <div className="space-y-6">
            ...
            {!isPast && comp.registrationLink ? (
              <Button
                className="w-full h-14 md:h-16 rounded-xl md:rounded-2xl bg-white text-black font-black uppercase tracking-widest hover:scale-[1.02] transition-all shadow-[0_0_30px_rgba(255,255,255,0.1)] group/btn"
      ...
      >
        <div className="space-y-6 md:space-y-8">
          ...
          <h1 className="text-5xl md:text-8xl lg:text-9xl font-black tracking-tighter text-white leading-tight">
            ...
            <span className="text-white/20">Competitions.</span>
          </h1>
