...
const clubs = [
  ...
  },
  {
    ...
    name: "Coding Club",
    tagline:
      "Build, create and problem-solve through beginner-friendly coding.",
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        >
          ...
          <p className="text-xl text-white/50 max-w-2xl leading-relaxed">
            From arts to coding, science to storytelling — there's a club for
            every curious mind. Choose your adventure and start exploring!
          </p>
        </motion.div>
        ...
        >
          <p className="text-white/40 text-sm mb-6">
            Can't find what you're looking for? Get in touch and we'll help you
            find the right fit.
          </p>
          <Link
            to="/contact"
